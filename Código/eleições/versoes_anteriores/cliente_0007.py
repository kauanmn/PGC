...
#teste = int.from_bytes(voto, byteorder='big')
...
#tse_rsa_private_key = read_private_key('./files/tse/rsa_private_key.pem', b'9999')
...
# teste de descriptografar o voto secreto
#voto_decrypt = tse_rsa_private_key.decrypt(
#        voto_secreto,
#        padding.OAEP(
#                mgf=padding.MGF1(algorithm=hashes.SHA384()),
#                algorithm=hashes.SHA384(),
...
#enc_assinatura = encryptor.update(assinatura)
#enc_voto_secreto = encryptor.update(voto_secreto)
#enc_cert = encryptor.update(cert)
...
#teste1  = aes_decrypt_data(enc_voto_secreto, derived_key, iv)
