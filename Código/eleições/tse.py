...
# ler chave pública de um arquivo .pem5
...
cert = x509.load_pem_x509_certificate(cert_pem)
ct_public_key = cert.public_key()

# carregar chaves públicas TSE
tse_ec_public_key  = read_public_key(path_tse +  'ec_public_key.pem')
tse_rsa_public_key = read_public_key(path_tse + 'rsa_public_key.pem')
...
if(validade_assinatura):
	...
	print('Você votou pelo ' + get_cert_issuer(cert))
else:
